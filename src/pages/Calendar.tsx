          ...
          <TabsList className="flex h-full w-full justify-between bg-secondaryBg p-0">
            {daysOfWeek.map((day) => (
              <TabsTrigger
                ...
                className="border border-secondaryBg px-10 py-3 data-[state=active]:border-secondary data-[state=active]:bg-secondary-hover data-[state=active]:text-secondary"
              >
